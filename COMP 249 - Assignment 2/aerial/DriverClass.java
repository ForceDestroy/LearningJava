...
class DriverClass {
	public static void main(String[] args) {
		...
		System.out.println(q1.equals(m1));
		System.out.println(u1.equals(ad1));
		
		for(int i = 0; i < array.length; i++) {
			if( array[i].Price <= array[cheapest].Price) {
				secondCheapest = cheapest;
				cheapest = i;
			}
			else if(array[i].Price <= array[secondCheapest].Price){
				secondCheapest = i;
			}else {
		...
		System.out.println(array[cheapest] + ". This is the cheapest flying object in the array.");
		System.out.println(array[secondCheapest] + ". This is the second cheapest flying object in the array.");
